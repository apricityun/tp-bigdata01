		...
		<div class="col-12">
			<div class="card my-4">
				...
				<div class="card-body px-0 pb-2">
					<div class="table-responsive p-0">
						<a class="btn btn-link text-secondary mb-0" href="/qna/register">글쓰기</a>
							...
							<table class="position-relative table align-items-center mb-0">
								...
								<tbody>
									<c:forEach items="${list}" var="board">
										<tr>
											<td><p class="text-xs font-weight-bold mb-0 px-3">${board.bno}</p></td>
											<td>
												<div class="d-flex px-2 py-1">
													<div class="d-flex flex-column justify-content-center">
														<h6 class="mb-0 text-sm">
															<a class="text-xs font-weight-bold mb-0"
																href="/qna/detail?bno=${board.bno}&pageNum=${p.currentPage}&field=${field}&word=${word}">${board.title}</a>
														</h6>
														<p class="text-xs font-weight-bold mb-0">${board.writer}</p>
													</div>
												</div>
											</td>
											<td><p class="text-xs font-weight-bold mb-0 px-3">
			...
			<div
				...
				<form class=" form-inline" action="/qna/list" id="searchFrm">
					...
					</select> <input type="text" class="form-control mb-2 mr-sm-3"

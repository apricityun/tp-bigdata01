				...
				<div class="card">
                    ...
                    <span class="text-xs">VAT Number: <span class="text-dark ms-sm-2 font-weight-bold">FRB1235476</span></span> -->
									<form action="insert" method="post"
										...
										<!-- <div class="form-group">
											<label for="fileUpload">파일업로드:</label> <input type="file"
								...
								<div class="d-flex flex-column">
									...
									<span class="mb-2 text-xs">Company Name: <span
										class="text-dark font-weight-bold ms-sm-2">Stone Tech
											Zone</span></span> <span class="mb-2 text-xs">Email Address: <span
					...
					<div class="card-header pb-0 px-3">
						<div class="row">
							...
							<div
								...
								<i class="material-icons me-2 text-lg">date_range</i> <small>23
									- 30 March 2020</small>
							</div>
						</div>
					</div>

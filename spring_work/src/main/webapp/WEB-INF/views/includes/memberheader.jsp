			...
			<ul class="navbar-nav mx-auto">
				<li class="nav-item"><a
					...
					aria-current="page" href="/"> <i
						class="fa fa-chart-pie opacity-6 text-dark me-1"></i>메인화면
				</a></li>
				<!-- <li class="nav-item"><a class="nav-link me-2"
					href="/member/userinfo"> <i
						class="fa fa-user opacity-6 text-dark me-1"></i>내정보
				</a></li> -->
				<li class="nav-item"><a class="nav-link me-2"
					href="/member/login"> <i
						class="fas fa-user-circle opacity-6 text-dark me-1"></i>로그인
				</a></li>
				<li class="nav-item"><a class="nav-link me-2"
					href="/member/join"> <i
						class="fas fa-key opacity-6 text-dark me-1"></i>회원가입
				</a></li>
			</ul>
			<!-- <ul class="navbar-nav d-lg-block d-none">
				<li class="nav-item"><a
					href="https://www.creative-tim.com/product/material-dashboard"
					class="btn btn-sm mb-0 me-1 bg-gradient-dark">Free download</a></li>
			</ul> -->
		</div>
	</div>
</nav>

	...
	<div class="container-fluid py-1 px-3">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
				<li class="breadcrumb-item text-sm"><i class="fa fa-cloud"
					style="color: #0000FF;"></i> <a class="opacity-5 text-dark"
					href="javascript:;"> Howair </a> <i class="fa fa-cloud"
					style="color: #0000FF;"></i></li>
			</ol>
			...
			<ul class="navbar-nav  justify-content-end">
				<c:choose>
					...
					<c:when test="${empty sessionScope.sMember}">
						...
						<a href="../member/login" class="nav-link text-body font-weight-bold px-0">
								<i class="fa fa-user me-sm-1"></i> <span class="d-sm-inline d-none">
									로그인 </span>
						</a></li>
					</c:when>
					<c:otherwise>

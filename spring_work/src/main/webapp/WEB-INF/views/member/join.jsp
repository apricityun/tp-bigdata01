						...
						<div
							...
							<div class="card card-plain">
								<div class="card-header">
									...
									<p class="mb-0">회원님의 이름, 이메일, 비밀번호를 입력해주세요</p>
								</div>
								<div class="card-body">
									<form role="form">
										...
										<div class="form-check form-check-info text-start ps-0">
											<input class="form-check-input" type="checkbox" value=""
												...
												개인정보 제공에 <a href="javascript:;"
												class="text-dark font-weight-bolder">동의합니다</a>
											</label>
										</div>
										<div class="text-center">
											<button type="button" id="btnJoin"
												class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">가입하기</button>
										</div>
									</form>
								</div>
								<div class="card-footer text-center pt-0 px-lg-2 px-1">
									<p class="mb-2 text-sm mx-auto">
										이미 회원이신가요? <a href="/member/login"

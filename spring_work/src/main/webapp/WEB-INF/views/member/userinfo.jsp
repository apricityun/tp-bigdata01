						...
						<div class="card z-index-0 fadeIn3 fadeInBottom">
							<div
								...
								<div
									...
									<h4 class="text-white font-weight-bolder text-center mt-2 mb-0">회원수정</h4>
									<div class="row mt-3">
							...
							<div class="card-body">
								<form role="form" class="text-start" action="/member/modify" method="post">
									<div class="input-group input-group-outline my-3">
										<label class="form-label"></label> <input type="email" id="email" 
											class="form-control" value="${member.id}" readonly>
									</div>
									<div class="input-group input-group-outline my-3">
										<label class="form-label"></label> <input type="text" id="name" placeholder="이름을 입력해주세요"
									...
									<div class="text-center">
										<button type="button"
											class="btn bg-gradient-primary w-100 my-4 mb-2" id="btnModify">수정하기</button>
									</div>
								</form>
							</div>
						</div>

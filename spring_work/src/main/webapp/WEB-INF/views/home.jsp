		...
		<div class="row">
			...
			<div class="col-xl-4 col-sm-7 mb-xl-0 mb-4">
				...
				<div class="input-group input-group-outline">
					<!-- selectbox로 선택하게 -->
					<select id="redregion" class="form-label"
						name="search_option">
				...
				<button class="btn bg-gradient-primary w-30 my-4 mb-4"
					id="btn-red-region">선택</button>
				<h6>시간 #1</h6>
				<div class="input-group input-group-outline">
					<!-- selectbox로 선택하게 -->
				...
				<button class="btn bg-gradient-primary w-30 my-4 mb-2" id="btn-red">검색</button>
			</div>
			<div class="col-xl-4 col-sm-7 mb-xl-0 mb-4">
				<h6>지역 #2</h6>
				<div class="input-group input-group-outline">
				...
				<button class="btn bg-gradient-success w-30 my-4 mb-4"
					id="btn-green-region">선택</button>
				<h6>시간 #2</h6>
				<div class="input-group input-group-outline">
					<!-- selectbox로 선택하게 -->
				...
				<button class="btn bg-gradient-success w-30 my-4 mb-2"
					id="btn-green">검색</button>
			</div>
			<div class="col-xl-4 col-sm-7 mb-xl-0 mb-4">
				<h6>지역 #3</h6>
				<div class="input-group input-group-outline">
				...
				<button class="btn bg-gradient-dark w-30 my-4 mb-4"
					id="btn-dark-region">선택</button>
				<h6>시간 #3</h6>
				<div class="input-group input-group-outline">
					<!-- selectbox로 선택하게 -->
				...
				<button class="btn bg-gradient-dark w-30 my-4 mb-2" id="btn-dark">검색</button>
			</div>
		</div>
		<div class="row mt-4">
				...
				<div class="card z-index-2 ">
					<div
						...
						<div
							...
							<div class="chartred">
								<canvas id="chart-red" class="chart-canvas" height="170"></canvas>
							</div>
						</div>
					</div>
					...
					<div
						...
						<div
							...
							<div class="chartgreen">
								<canvas id="chart-green" class="chart-canvas" height="170"></canvas>
							</div>
						</div>
					</div>
					<div class="card-body" style="height:70px">
				...
				<div class="card z-index-2 ">
					<div
						...
						<div
							...
							<div class="chartdark">
								<canvas id="chart-dark" class="chart-canvas" height="170"></canvas>
							</div>
						</div>
					</div>
					<div class="card-body" style="height:70px">

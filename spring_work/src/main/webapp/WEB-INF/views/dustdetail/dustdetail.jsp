	...
	<div class="container-fluid py-4">
		...
		<div class="row">
			<div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
				...
				<button class="btn bg-gradient-success w-30 my-4 mb-4" id="btn-year">선택</button>
				<div class="input-group input-group-outline">
					<!-- selectbox로 선택하게 -->
					<select id="selectRegion" name="selectRegion" class="form-label"
						name="search_option">
						<option>연도를 선택해주세요</option>
					</select>
				</div>
				<button class="btn bg-gradient-success w-30 my-4 mb-2" id="btn">검색</button>
			</div>
		...
		<div class="row mt-4">
			...
			<div>
				<input id="detailbtn" class="btn bg-gradient-primary w-7 my-4 mb-2"
					value="상세보기"
